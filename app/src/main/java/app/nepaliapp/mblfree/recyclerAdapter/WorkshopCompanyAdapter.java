...
public class WorkshopCompanyAdapter extends RecyclerView.Adapter<WorkshopCompanyAdapter.ViewHolder> {
   Context context;
   JSONArray array;

    public WorkshopCompanyAdapter(Context context, JSONArray array) {
        ...
        try {
            ...
            holder.clickAble.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   changeFragment(obj.optString("name"));
                }
            });
    ...
    private void changeFragment(String companyName) {
