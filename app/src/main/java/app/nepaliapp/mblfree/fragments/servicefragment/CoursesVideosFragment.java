...
public class CoursesVideosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_courses_videos, container, false);
        init(view);
    ...
    private void requestTutorialVideos() {
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url.getCourseVideos(), null, new Response.Listener<JSONObject>() {
            @Override
